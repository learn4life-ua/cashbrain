...
const timelines=[
  {id:'a',label:'Версія А',text:'Публічний Wi-Fi скопіював картку → чек підтвердив оплату → шахрай підібрав пароль → відбувся переказ.',correct:false},
  {id:'b',label:'Версія Б',text:'Банк заблокував платіж → Марта скасувала його на офіційному сайті → стався технічний повтор списання.',correct:false},
  {id:'c',label:'Версія В',text:'SMS із посиланням → підроблена форма отримала реквізити → код підтвердив новий вхід → відбувся переказ.',correct:true},
  {id:'d',label:'Версія Г',text:'Шахрай списав гроші → банк надіслав код → Марта відкрила сайт → з’явився новий пристрій.',correct:false}
];

const suspects=[
  {id:'nfc',mark:'01',title:'Безконтактне копіювання картки',text:'Дані нібито зчитали поруч із Мартою, хоча картку не використовували й фізичного контакту не зафіксовано.',correct:false},
  {id:'bank',mark:'02',title:'Технічний збій банку',text:'Система нібито помилково провела переказ і випадково зареєструвала сторонній пристрій.',correct:false},
  {id:'phishing',mark:'03',title:'Фішинг і соціальна інженерія',text:'Тривожне повідомлення спрямувало на підроблений сайт, де виманили реквізити й одноразовий код.',correct:true},
...
const responses=[
  {id:'chat',mark:'01',title:'Написати у чат на підозрілому сайті',text:'Попросити «службу безпеки» повернути кошти й чекати відповіді.',correct:false},
  {id:'block',mark:'02',title:'Заблокувати картку й онлайн-доступ',text:'Зателефонувати до банку за офіційним номером або скористатися банківським застосунком.',correct:true,order:1},
  ...
  {id:'post',mark:'04',title:'Одразу опублікувати все в соцмережі',text:'Викласти повний номер картки, SMS і чек, щоб інші побачили докази.',correct:false},
  {id:'password',mark:'05',title:'Змінити пароль і завершити чужі сесії',text:'Зробити це з безпечного пристрою після блокування доступу.',correct:true,order:2},
  {id:'police',mark:'06',title:'Подати звернення до Кіберполіції',text:'Передати опис події, посилання, часові мітки та реквізити операції.',correct:true,order:4}
];
